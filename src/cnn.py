...
FREQ_DIST_FILE = './dataset/tweets/tweets_pos_neg_train-processed-freqdist.pkl'
BI_FREQ_DIST_FILE = './dataset/tweets/tweets_pos_neg_train-processed-freqdist-bi.pkl'

TRAIN_PROCESSED_FILE = './dataset/tweets/tweets_pos_neg_train-processed.csv'
TEST_PROCESSED_FILE = './dataset/tweets/tweets_pos_neg_test-processed.csv'
